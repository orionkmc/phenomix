...
<main>
	...
	<div id="contact">
		<section class="contact-form pt-5">
			<form data-toggle="appear" data-appear-class="fadeInDownTwo" class="appear container">
				<div class="row">
				...
				<div class="row">
					<div class="col-lg-3 contact-form-phone">
						<div class="row">
							...
							<div class="col-9 p-0 text-center">
								<p>
									info@phenomixsciences.com 1000 Westgate Drive Suite 1002-1003 St. Paul, MN 55114
								</p>
							</div>
						</div>
						<div class="row">
					...
					<div class="col-lg-9">
						<div class="row">
							...
							<div class="padding-submit col-lg-4">
								<div class="form-group">
