  ...
  <div class="container">
    <div class="menu">
      ...
      <ul class="menu-center">
        <li class="im">
          <a href="index.php#obesity-phenotyping" data-slide="1" class="">
            Obesity Phenotyping
          </a>                      
        </li>
        <li class="im">
          <a href="index.php#maximize-your-weight-loss" data-slide="2">
...
<nav class="header">
  <div class="container">
    <ul class="menu-center">
      <li class="im">
        <a href="index.php#obesity-phenotyping" data-slide="1">
          Obesity Phenotyping
        </a>                      
      </li>
      <li class="im">
