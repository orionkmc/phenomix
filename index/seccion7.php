<div class="swiper-slide" data-hash="what-others-are-saying">
  <section id="what-others-are-saying">
    <div class="container header">
      <h2 data-toggle="appear" data-appear-class="fadeInDown" class="appear text-center text-lg-left">What Others <br class="d-none d-lg-block">are Saying</h2>
      ...
      <div data-toggle="appear" data-appear-class="fadeIn slow delay-2" class="appear slick-saying">
        ...
        <div>
          ...
          <!-- <span class="quotes quotes-close d-none d-lg-block">“</span> -->
          <div class="content">
            <img src="assets/images/bio/angela_golden.jpg" class="img-fluid rounded-circle">
